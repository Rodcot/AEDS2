...
class FilaCircular {
    ...
    public void enfileira(Serie valorSerie) throws Exception {
        tras.prox = new Celula(valorSerie);
        tras = tras.prox;
        qtde++;
    ...
    public int getMedia(){
        ...
        for(Celula i = frente; i != tras; i = i.prox){
            sum =  sum + i.item.getnTemporadas();
            count++;    
        }
