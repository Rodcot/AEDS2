...
class TP3ex9{
    ...
    public static void mergeSort(Serie[] series, int start, int end) throws Exception{
        if (start < end){
            int meio = (start + end) / 2;
            mergeSort(series, start, meio);
            mergeSort(series, meio + 1, end);
            
            //começo do sort de verdade.
            int n1, n2, i, j, k;
            ...
            while(i < n1 && j < n2){
                if(a1[i].getnEpisodios() < a2[j].getnEpisodios()){
                    series[k] = a1[i];
                    i++;
                    comparacoes++;
                    movimentacoes++;
                }else if(a1[i].getnEpisodios() == a2[j].getnEpisodios()){
                    comparacoes++;
    ...
    public static void main(String[] args) throws Exception{
        ...
        Arq.openWrite("matrícula_mergesort.txt", "UTF-8");
