...
void palavrasComando(char *entrada){
    ...
    if(entrada[0] == 'I' && entrada[1] == 'I'){
        ...
        inserirInicio(acharLer(diretorio));
    }else if(entrada[0] == 'I' && entrada[1] == 'F'){
       temp[0] = strtok(entrada," "); 
       temp[1] = strtok(NULL," "); 
       strcat(diretorio, temp[1]);
       inserirFim(acharLer(diretorio));
    }else if(entrada[0] == 'I' && entrada[1] == '*'){
        temp[0] = strtok(entrada," "); 
        temp[1] = strtok(NULL," ");
        temp[2] = strtok(NULL," ");
        strcat(diretorio, temp[2]);
        inserir(acharLer(diretorio), atoi(temp[1]));
    }else if(entrada[0] == 'R' && entrada[1] == '*'){
        temp[0] = strtok(entrada," "); 
        temp[1] = strtok(NULL," ");
        removed[removedCount] = remover(atoi(temp[1]));
        removedCount++;
    }else if(entrada[0] == 'R' && entrada[1] == 'I'){
        removed[removedCount] =  removerInicio();
        removedCount++;
    }else if(entrada[0] == 'R' && entrada[1] == 'F'){
        removed[removedCount] = removerFim();
        removedCount++;
    }
}
